			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="new-member.php">New</a></li>
							<li><a href="manage-members.php">Manage</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-book"></span><span class="mtext">Books</span>
						</a>
						<ul class="submenu">
							<li><a href="new-book.php">New</a></li>
							<li><a href="#">Manage</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle no-arrow">
							<span class="fa fa-edit"></span><span class="mtext">Issue Book</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle no-arrow">
							<span class="fa fa-undo"></span><span class="mtext">Return Book</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle no-arrow">
							<span class="fa fa-book"></span><span class="mtext">Report(s)</span>
						</a>
					</li>
					<!--<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
